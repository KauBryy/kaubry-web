...
import {
  ...
  ArrowUpRight, Mail, MapPin, Flame, Trophy, Zap, Users, Store,
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
            <div>
              ...
              <h2 className="text-[8vw] md:text-[5vw] font-black uppercase italic tracking-tighter mb-10 text-white leading-none">L'art de la <br /> <span className="whitespace-nowrap">transformation.</span></h2>
